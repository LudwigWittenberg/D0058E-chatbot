/**
 * Settings page JavaScript — Agents App
 *
...
(function () {
    ...
    const processTypeSelect = document.getElementById("crew-process-type");
    ...
    async function loadConfig() {
        try {
            ...
            if (config.crew_process_type) processTypeSelect.value = config.crew_process_type;
            if (config.max_iterations !== undefined) maxIterationsInput.value = config.max_iterations;
    ...
    async function saveConfig() {
        ...
        const payload = {
            ...
            crew_process_type: processTypeSelect.value,
            max_iterations: parseInt(maxIterationsInput.value, 10),
